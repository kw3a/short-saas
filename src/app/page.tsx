      ...
      <div className="flex-1">
        ...
        <section className="py-20 bg-zinc-900/30">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Create Viral Content?</h2>
            <p className="text-xl text-zinc-300 mb-8 max-w-2xl mx-auto">
              Join thousands of creators who are already growing their audience with ViralShort.
            </p>
